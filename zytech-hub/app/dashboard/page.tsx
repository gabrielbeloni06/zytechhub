...
import { 
  ...
  Plus, Search, DollarSign, Inbox // Adicionei o Inbox aqui
} from 'lucide-react'
      ...
      <div className="relative z-10 max-w-7xl mx-auto p-6 md:p-12 space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <KpiCard 
            ...
            icon={Inbox} // Troquei Target por Inbox pra destacar
          />
          <KpiCard 
            title="IA Operando" 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 animate-in fade-in slide-in-from-bottom-8 duration-1000">
            ...
            <div className="space-y-4">
                <div className="p-6 rounded-3xl bg-zinc-900/50 border border-white/10 h-full flex flex-col gap-4">
                    ...
                    {/* NOVO BOTÃO: CAIXA DE ENTRADA (LINKADO PARA /dashboard/forms) */}
                    <Link href="/dashboard/forms" className="group w-full p-4 rounded-2xl bg-white/10 border border-white/20 hover:bg-white/20 hover:border-white/40 transition-all flex items-center justify-between shadow-[0_0_20px_rgba(255,255,255,0.05)]">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] text-zinc-400">Ver pedidos recentes</p>
                            </div>
                        </div>
